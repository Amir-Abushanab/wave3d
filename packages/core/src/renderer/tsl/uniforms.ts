...
export function makeTslUniforms(drawingBufferSize: Vector2) {
  ...
  return {
    ...
    uGlassStrength: uniform(28),
    uGlassChroma: uniform(0.45),
    uGlassFrost: uniform(0.25),
    uGlassSpec: uniform(0.9),
    uGlassVibrancy: uniform(0.12),
    uGlassTint: uniform(0.9),
    uGlassRimPower: uniform(1.5),
    uGlassRipple: uniform(0),
    uGlassRippleScale: uniform(0.012),
    uGlassFlow: uniform(0.9),
    uGlassPath: uniform(1),
    uGlassDensity: uniform(4),
    uGlassRim: uniform(0.28),
    uGlassIrid: uniform(0),
    uGlassFilmNm: uniform(380),
    uGlassIor: uniform(1.45),
    uGlassLayerGain: uniform(0.6),
    uGlassFusion: uniform(0),
    uGlassCaustic: uniform(0),
