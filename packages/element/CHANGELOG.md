...
- [#35](https://github.com/Amir-Abushanab/wave3d/pull/35) [`a34ef52`](https://github.com/Amir-Abushanab/wave3d/commit/a34ef52ae01f2e41585acbb59f9ab9c07dd50ae4) Thanks [@Amir-Abushanab](https://github.com/Amir-Abushanab)! - Lights: a screen-bounded `spread`, and `setLights()` for lights that move.
...
- Updated dependencies [[`dcef321`](https://github.com/Amir-Abushanab/wave3d/commit/dcef321dc3b393b37a4f729a0a7e00ae4f50cc38)]:
  - @wave3d/core@0.11.1
...
- [#28](https://github.com/Amir-Abushanab/wave3d/pull/28) [`67eebfb`](https://github.com/Amir-Abushanab/wave3d/commit/67eebfb82d6bf0d9946c8caf130eec5b3ef7320a) Thanks [@Amir-Abushanab](https://github.com/Amir-Abushanab)! - Add a `fade-ms` attribute to `<wave-3d>`, exposing the shell's `fadeMs` option (poster→canvas crossfade duration, default 300ms) to the framework-agnostic element. `fade-ms="0"` swaps with no crossfade, which is what you want when the poster and the first live frame already match — a long dissolve between a frozen still and an animating scene is visible precisely because the two are no longer the same frame by the time it ends. Previously only reachable through `createWave`, so element users had no way to tune it.
